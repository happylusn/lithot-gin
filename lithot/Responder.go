...
func (this StringResponder) RespondTo() gin.HandlerFunc {
	return func(context *gin.Context) {
		context.String(200, getMiddlewareHandler().handlerMiddleware(this, context).(string))
	}
}
...
func (this JsonResponder) RespondTo() gin.HandlerFunc {
	return func(context *gin.Context) {
		context.JSON(200, getMiddlewareHandler().handlerMiddleware(this, context))
	}
}
...
func (this SqlQueryResponder) RespondTo() gin.HandlerFunc {
	return func(context *gin.Context) {
		getQuery := getMiddlewareHandler().handlerMiddleware(this, context).(Query)
...
func (this SqlResponder) RespondTo() gin.HandlerFunc {
	return func(context *gin.Context) {
		getSql := getMiddlewareHandler().handlerMiddleware(this, context).(SimpleQuery)
...
func (this VoidResponder) RespondTo() gin.HandlerFunc {
	return func(context *gin.Context) {
		getMiddlewareHandler().handlerMiddleware(this, context)
	}
}
